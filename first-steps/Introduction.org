...
[[google:https://doc.sccode.org/Guides/ClientVsServer.html#:~:text=two%20distinct%20tasks%3A-,Client,OSC%20messages%20to%20the%20server.&text=it%20is%20the%20interpreter%20for,to%20control%20the%20audio%20server.][Client vs Server]]
